        ...
        <table className="w-full text-sm border-collapse">
          <tbody>
            <tr className="bg-gray-50 border-b border-white">
              ...
              <td className="py-2 px-3 text-gray-800 font-medium text-right rounded-r">{product.brand || 'TMF'}</td>
            </tr>
        ...
        <div className="text-sm text-gray-600 leading-relaxed space-y-4">
          ...
          <div className="mt-4">
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li>Chất liệu an toàn, 100% chính hãng tại TMF.</li>
          ...
          <div className="mt-4">
            ...
            <ul className="space-y-1">
              <li>Thương hiệu: {product.brand || 'TMF'}</li>
