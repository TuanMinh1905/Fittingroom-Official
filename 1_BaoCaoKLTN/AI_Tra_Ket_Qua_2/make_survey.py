...
L1 = Emu(285750); L2 = Emu(857250); F1 = Emu(171450); HF = Emu(-285750)
...
def h2(text, cont=None):
    p = doc.add_paragraph()
    p.alignment = WD_ALIGN_PARAGRAPH.JUSTIFY
    run(p, text, bold=True, size_pt=13)
    if cont: run(p, cont, size_pt=13)
...
h2("1.2. Các ứng dụng tương tự để tham khảo", " Hiện nay, trên thị trường đã tồn tại một số nền tảng thương mại điện tử thời trang và hệ thống thử đồ ảo. Nhóm tác giả tiến hành khảo sát ba nền tảng tiêu biểu để rút ra bài học và định hướng phát triển.")
...
label("Nhược điểm:")
bullet("Tính năng thử đồ ảo chỉ ở mức 2D, không phản ánh chính xác mức độ ôm sát hay rộng rãi theo vóc dáng thực tế.")
...
bullet("Hệ thống cho phép người dùng duyệt và mua sắm sản phẩm thời trang: tìm kiếm, xem chi tiết, thêm vào giỏ hàng và đặt hàng.")
...
bullet("Thời gian phản hồi của API thương mại điện tử nhanh; thời gian render 3D được thông báo rõ ràng cho người dùng.")
